...
const Inspector = ({ entity }) => {
  const info = entityInfo[entity.name];
  const recipe = itemInfo[entity.recipe] ? itemInfo[entity.recipe] : recipeInfo[entity.recipe];
  return (
    <div className="inspector">
      ...
      {entity.recipe && <div>Recipe: <br /><img src={recipe.icon} /> {entity.recipe}</div>}
      {entity.items &&
      ...
      {entity.control_behavior &&
        <div>Control behavior:{entity.control_behavior.circuit_condition &&
          <div>
